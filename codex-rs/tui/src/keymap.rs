...
impl RuntimeKeymap {
    ...
    ///
    /// This keeps `v1` intact while adding Vim composer defaults and restoring
    /// `alt-d` as a forward-word delete alias so `latest` preserves editor
    /// behavior from `main`.
    fn defaults_v2() -> Self {
        ...
        defaults.vim_normal = VimNormalKeymap {
        ...
        defaults.vim_operator = VimOperatorKeymap {
